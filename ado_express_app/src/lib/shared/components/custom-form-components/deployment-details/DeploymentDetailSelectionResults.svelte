    ...
    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
      <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
        <div class="overflow-hidden">
          <table class="min-w-full text-center text-md font-normal text-gray-900">
            <thead
              class="border-b font-medium dark:text-gray-800">
              <tr>
            ...
            <tbody>
              ...
              <tr class="border-b">
                ...
                <td class="whitespace-nowrap px-6 py-4">{row.releaseProjectName}</td>
                <td class="whitespace-nowrap px-6 py-4">{row.releaseName}</td>
                <td class="whitespace-nowrap px-6 py-4">{row.releaseNumber}</td>
                <td class="whitespace-nowrap px-6 py-4">{row.releaseRollback}</td>
          ...
          <div class="flex flex-col justify-start mt-4">
            <p class="text-gray-900 font-bold mb-2">Something missing?</p>
            <button on:click={() => removeDeploymentDetails()} class="bg-transparent hover:bg-red-700 text-red-900 font-semibold hover:text-white py-2 px-4 border border-red-800 hover:border-transparent rounded-lg shadow-lg">Remove Values</button>
          </div>
        </div>
      </div>
    </div>
