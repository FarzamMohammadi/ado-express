...
<div class="input-field mb-4">
  ...
  <textarea
    ...
    class="resize-none border-2 rounded p-2 w-full {expand
      ...
      : 'h-11'}  text-gray-900 text-sm rounded-lg focus:outline-none focus:border-blue-600 w-full p-2.5 bg-gray-50 dark:bg-gray-700 border-gray-500 dark:text-white dark:focus:ring-blue-500"
