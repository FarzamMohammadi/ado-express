...
{#if showInput}
  <div class="input-field mb-4">
    ...
    <textarea
      ...
      } text-gray-900 text-sm rounded-lg focus:outline-none focus:border-blue-600 dark:focus:border-sky-500 w-full p-2.5 bg-gray-50 dark:bg-gray-700 border-gray-500 dark:text-white dark:focus:ring-blue-500 ${
        invalid ? 'invalid' : ''
      }`}
    />
  </div>
